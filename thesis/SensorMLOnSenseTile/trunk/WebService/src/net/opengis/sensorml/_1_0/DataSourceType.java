...
import net.opengis.swe._1_0.DataBlockDefinitionType;
import net.opengis.swe._1_0.DataStreamDefinitionType;
    ...
    extends AbstractProcessType
{
    ...
    protected DataSourceType.DataDefinition dataDefinition;
    protected DataSourceType.Values values;
    protected DataSourceType.ObservationReference observationReference;
    ...
    public boolean isSetObservationReference() {
        return (this.observationReference!= null);
    }
    ...
    public static class DataDefinition {
        ...
        protected DataBlockDefinitionType dataBlockDefinition;
        @XmlElement(name = "DataStreamDefinition", namespace = "http://www.opengis.net/swe/1.0.1")
        protected DataStreamDefinitionType dataStreamDefinition;
        ...
        public boolean isSetDataBlockDefinition() {
            return (this.dataBlockDefinition!= null);
        }
        ...
        public boolean isSetDataStreamDefinition() {
            return (this.dataStreamDefinition!= null);
        }
