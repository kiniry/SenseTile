...
public class ProcessLoader
{
    ...
    public static synchronized void loadMaps(String libFileUrl, boolean replace) throws SMLException
    {
        try
        {
            ...
            System.out.println("lib "+libFileUrl);
            FileInputStream inputxml = new FileInputStream(libFileUrl);
            DOMHelper dom = new DOMHelper(inputxml, false);
            System.out.println("loadmaps root "+dom.getRootElement());
            NodeList processElts = dom.getElements("Process");
            Element processElttest = dom.getElement("/Process");
            //System.out.println("test elt "+processElttest.getLocalName());
            if (processMap == null)
                processMap = new Hashtable<String,String>(processElts.getLength());
            System.out.println("processElts length "+processElts.getLength());
