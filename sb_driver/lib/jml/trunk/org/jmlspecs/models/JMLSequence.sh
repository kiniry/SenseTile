#! /bin/sh
# @(#)$Id: JMLSequence.sh,v 1.17 2008/10/24 18:07:50 smshaner Exp $
...
val_sed()
{
  sed -e ' s/_Elem_/Value/g
      ...
      @  }%g
           s%_Singleton_Constructor_Refining_Start_%\
           //@ JMLType copy = (JMLType)e.clone();\
           //@ refining behavior\
           //@   assignable this.*;\
           //@   ensures objectAt(0)== copy \&\& int_size() == 1;\
           {%g
           s%_Singleton_Constructor_Refining_End_%\
           }%g
           ...
           s%_Value_insertBeforeIndexPreamble_%\
                 /*@ assume item != null;\
                   @ assume 0 <= beforeThisOne \&\& beforeThisOne <= int_length();\
                   @ JMLType copy = (JMLType)item.clone(); @*/%g
           s%_Value_insertBeforeIndexMPBegin_%\
                 ...
                 {%g
           s!_Value_insertBeforeIndexMPEnd_!}!g
	 ' $1 >$2
}
 ...
 * @see JMLValueSequence/g
     ...
     //@    ensures \\result >= 0;!g
           ...
           s/_Singleton_Constructor_Refining_Start_//g
           s/_Singleton_Constructor_Refining_End_//g
           s%_Clone_Body_%return this;%g
           s/_Value_insertBeforeIndexPreamble_//g
           s/_Value_insertBeforeIndexMPBegin_//g
           s/_Value_insertBeforeIndexMPEnd_//g
	 ' $1 >$2
}
