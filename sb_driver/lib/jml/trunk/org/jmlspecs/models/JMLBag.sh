#! /bin/sh
# @(#)$Id: JMLBag.sh,v 1.18 2009/02/17 19:33:02 smshaner Exp $
  ...
  sed -e ' s/_Elem_/Value/g
      ...
      @  }%g
           ...
           s%_Clone_Entry_Body_%return new JMLValueBagEntry(theElem == null ? null\
                                     ...
                                     count);%g
           s%_ValueBag_Preamble_%//@    assume cnt >= 0;\
      //@    assume elem != null;\
      //@    assume int_size() < Integer.MAX_VALUE - cnt;\
      //@    JMLType copy = (JMLType) elem.clone();%g
           s%_ValueBag_Refining_Start_%//@    refining normal_behavior\
...
eqls_sed()
{
  sed -e ' s/_Elem_/Equals/g
     ...
     * @see JMLValueBag/g
	   ...
	   s!_alsoIfValue_!!g
           s!_ValueBag_Preamble_!!g
           s!_ValueBag_Refining_Start_!!g
           s!_ValueBag_Refining_End_!!g
