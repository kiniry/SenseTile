 ...
 */
public abstract class InputStreamPacketInputStream_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public InputStreamPacketInputStream_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite(
        "Overall tests for InputStreamPacketInputStream");
  }
   ...
   * of type int for testing the method named by the String methodName in a loop
   * that encloses loopsThisSurrounds many other loops.
   * 
   * @param methodName
  ...
  protected org.jmlspecs.jmlunit.strategies.IntIterator vintIter(
   ...
   */
  private org.jmlspecs.jmlunit.strategies.IntStrategyType vintStrategy = new org.jmlspecs.jmlunit.strategies.IntStrategy() {
    protected int[] addData() {
      return DriverGenerator.getIntArrayLimted();
    }
  };

  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type java.util.Properties for testing the method named by the String
   * methodName in a loop that encloses loopsThisSurrounds many other loops.
   * 
   * @param methodName
   *          name of the method for which this test data will be used.
   * @param loopsThisSurrounds
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vjava_util_PropertiesIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vjava_util_PropertiesStrategy.iterator();
  }

  /**
   * The strategy for generating test data of type java.util.Properties.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vjava_util_PropertiesStrategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return DriverGenerator.getInputStreamPacketInputStreamPropertiesArray();
    }

    // @ also
    // @ requires o$ != null;
    protected Object cloneElement(java.lang.Object o$) {
      java.util.Properties down$ = (java.util.Properties) o$;
      return down$.clone();
    }
  };
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type java.io.InputStream for testing the method named by the String
   * methodName in a loop that encloses loopsThisSurrounds many other loops.
   * 
   * @param methodName
   *          name of the method for which this test data will be used.
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vjava_io_InputStreamIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vjava_io_InputStreamStrategy.iterator();
  }

  /**
   * The strategy for generating test data of type java.io.InputStream.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vjava_io_InputStreamStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return DriverGenerator.getInputStream(n);
    }
  };

  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.driver.InputStreamPacketInputStream
   * for testing the method named by the String methodName in a loop that
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_driver_InputStreamPacketInputStreamStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.Packet[] for testing the method named
   * by the String methodName in a loop that encloses loopsThisSurrounds many
   * other loops.
   * 
   * @param methodName
   *          name of the method for which this test data will be used.
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_Packet$_Iter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_Packet$_Strategy.iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_Packet$_Strategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return DriverGenerator.getPacketArrayEmptyArray();
    }

    // @ also
    // @ requires o$ != null;
    protected Object cloneElement(java.lang.Object o$) {
      ie.ucd.sensetile.sensorboard.Packet[] down$ = (ie.ucd.sensetile.sensorboard.Packet[]) o$;
      return down$.clone();
    }
  };
}
