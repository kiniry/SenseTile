...
/**
 * Supply test data for the JML and JUnit based testing of ByteArrayFrame.
 * 
 * <p>
 ...
 */
public abstract class ByteArrayFrame_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public ByteArrayFrame_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for ByteArrayFrame");
  }
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_driver_ByteArrayFrameIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_driver_ByteArrayFrameStrategy
        .iterator();
  }

  /**
   * The strategy for generating test data of type
   * ie.ucd.sensetile.sensorboard.driver.ByteArrayFrame.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_driver_ByteArrayFrameStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
