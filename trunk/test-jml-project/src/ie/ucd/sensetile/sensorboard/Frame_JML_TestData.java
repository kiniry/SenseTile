...
/**
 * Supply test data for the JML and JUnit based testing of Frame.
 * 
 * <p>
 ...
 */
public abstract class Frame_JML_TestData extends junit.framework.TestCase {
  /** Initialize this class. */
  public Frame_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for Frame");
  }
  ...
  private org.jmlspecs.jmlunit.strategies.IntStrategyType vintStrategy = new org.jmlspecs.jmlunit.strategies.IntStrategy() {
     ...
     * ie.ucd.sensetile.sensorboard.Frame
    ...
    protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator
        vie_ucd_sensetile_sensorboard_FrameIter
        (java.lang.String methodName, int loopsThisSurrounds)
    {
        return vie_ucd_sensetile_sensorboard_FrameStrategy.iterator();
    }
   ...
   * ie.ucd.sensetile.sensorboard.Frame.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_FrameStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return Generator.getFrame(n);
    }
  };
}
