...
/**
 * Supply test data for the JML and JUnit based testing of ByteArrayPacket.
 * 
 * <p>
 ...
 */
public abstract class ByteArrayPacket_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public ByteArrayPacket_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for ByteArrayPacket");
  }
   ...
   * of type byte[] for testing the method named by the String methodName in a
   * loop that encloses loopsThisSurrounds many other loops.
   * 
   * @param methodName
  ...
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vbyte$_Iter(
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vbyte$_Strategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return DriverGenerator.getByteArrayArray();
    }
  ...
  private org.jmlspecs.jmlunit.strategies.IntStrategyType vintStrategy = new org.jmlspecs.jmlunit.strategies.IntStrategy() {
    protected int[] addData() {
      return DriverGenerator.getIntArray();
    }
  };

  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.driver.ByteArrayPacket for testing the
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_driver_ByteArrayPacketIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_driver_ByteArrayPacketStrategy
        .iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_driver_ByteArrayPacketStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.Packet for testing the method named by
   * the String methodName in a loop that encloses loopsThisSurrounds many other
   * loops.
   * 
   * @param methodName
   *          name of the method for which this test data will be used.
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_PacketIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_PacketStrategy.iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_PacketStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return DriverGenerator.getByteArrayPacket(n);
    }
  };
