// This file was generated by jmlunit on Fri Sep 11 17:25:55 IST 2009.

package ie.ucd.sensetile.sensorboard.simulator;


/**
 * Supply test data for the JML and JUnit based testing of InstanceFrame.
 * 
 * <p>
 ...
 */
public abstract class InstanceFrame_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public InstanceFrame_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for InstanceFrame");
  }
   ...
   * of type ie.ucd.sensetile.sensorboard.simulator.InstanceFrame for testing
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_simulator_InstanceFrameIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_simulator_InstanceFrameStrategy
        .iterator();
  }

  /**
   * The strategy for generating test data of type
   * ie.ucd.sensetile.sensorboard.simulator.InstanceFrame.
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_simulator_InstanceFrameStrategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return SimulatorGenerator.getInstanceFrameArray();
    }

    // @ also
    // @ requires o$ != null;
    protected Object cloneElement(java.lang.Object o$) {
      ie.ucd.sensetile.sensorboard.simulator.InstanceFrame down$ = (ie.ucd.sensetile.sensorboard.simulator.InstanceFrame) o$;
      try {
        return down$.clone();
