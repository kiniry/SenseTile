...
/**
 * Supply test data for the JML and JUnit based testing of InstancePacket.
 * 
 * <p>
 ...
 */
public abstract class InstancePacket_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public InstancePacket_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for InstancePacket");
  }
  ...
  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.simulator.InstancePacket for testing
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_simulator_InstancePacketIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_simulator_InstancePacketStrategy
        .iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_simulator_InstancePacketStrategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return SimulatorGenerator.getInstancePacketArray();
    }

    // @ also
    // @ requires o$ != null;
    protected Object cloneElement(java.lang.Object o$) {
      ie.ucd.sensetile.sensorboard.simulator.InstancePacket down$ = (ie.ucd.sensetile.sensorboard.simulator.InstancePacket) o$;
      try {
        return down$.clone();
