 ...
 */
public abstract class SimulatorPacketInputStream_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public SimulatorPacketInputStream_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite(
        "Overall tests for SimulatorPacketInputStream");
  }
  ...
  private org.jmlspecs.jmlunit.strategies.IntStrategyType vintStrategy = new org.jmlspecs.jmlunit.strategies.IntStrategy() {
    protected int[] addData() {
      return SimulatorGenerator.getIntArray();
    }
  };

  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.simulator.PacketBuilder for testing
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_simulator_PacketBuilderIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_simulator_PacketBuilderStrategy
        .iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_simulator_PacketBuilderStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return SimulatorGenerator.getPacketBuilder(n);
    }
  };

  /**
   * Return a new, freshly allocated indefinite iterator that produces test data
   * of type ie.ucd.sensetile.sensorboard.simulator.SimulatorPacketInputStream
  ...
  // @ requires methodName != null && loopsThisSurrounds >= 0;
  // @ ensures \fresh(\result);
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_simulator_SimulatorPacketInputStreamIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_simulator_SimulatorPacketInputStreamStrategy
        .iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_simulator_SimulatorPacketInputStreamStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return SimulatorGenerator.getSimulatorPacketInputStream(n);
    }
  };
