...
/**
 * Supply test data for the JML and JUnit based testing of PacketInputStream.
 * 
 * <p>
 ...
 */
public abstract class PacketInputStream_JML_TestData extends
    junit.framework.TestCase {
  /** Initialize this class. */
  public PacketInputStream_JML_TestData(java.lang.String name) {
    super(name);
  }
  ...
  public junit.framework.TestSuite overallTestSuite() {
    return new junit.framework.TestSuite("Overall tests for PacketInputStream");
  }
   ...
   * of type ie.ucd.sensetile.sensorboard.PacketInputStream for testing the
  ...
  protected org.jmlspecs.jmlunit.strategies.IndefiniteIterator vie_ucd_sensetile_sensorboard_PacketInputStreamIter(
      java.lang.String methodName, int loopsThisSurrounds) {
    return vie_ucd_sensetile_sensorboard_PacketInputStreamStrategy.iterator();
  }
   ...
   */
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_PacketInputStreamStrategy = new org.jmlspecs.jmlunit.strategies.NewObjectAbstractStrategy() {
    protected Object make(int n) {
      return Generator.getPacketInputStream(n);
    }
  };
  ...
  private org.jmlspecs.jmlunit.strategies.IntStrategyType vintStrategy = new org.jmlspecs.jmlunit.strategies.IntStrategy() {
    protected int[] addData() {
      return Generator.getIntArrayLimted();
    }
  };
  ...
  private org.jmlspecs.jmlunit.strategies.StrategyType vie_ucd_sensetile_sensorboard_Packet$_Strategy = new org.jmlspecs.jmlunit.strategies.CloneableObjectAbstractStrategy() {
    protected java.lang.Object[] addData() {
      return Generator.getPacketArrayEmptyArray();
    }
