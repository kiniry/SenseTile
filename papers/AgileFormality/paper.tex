...
\ifpdf 
  \usepackage{epstopdf}
  \usepackage[pdftex,bookmarks=false,a4paper=true,plainpages=false,naturalnames=true,
  colorlinks=true,pdfstartview=FitV,linkcolor=blue,citecolor=blue,urlcolor=blue,
  pdfauthor="Vieri del Bianco and Joseph R. Kiniry and Dragan
  Stosic"]{hyperref} 
\else
...
% what about having the chat next week?
% on thursday, maybe?

% here are my comments on the reviewers:

% ---------------------------- REVIEW 1 --------------------------
% OVERALL RATING: 3 (strong accept)

% > This paper successfully bridges the gab between both worlds. I would be i=
% nteresting to read at bit more about the gained experience with the techniq=
% ues based on the presented case study (what was easy what difficult).

% agree. to be included

% > Furthermore I recommend that the authors work out a bit more detailed the=
%  prerequisites to apply a mixture of formal and agile techniques (e.g. by m=
% eans of a list of "thesis"). This would stimulate the discussion!

% agree. to be included. it's already there, but not clear and polished enoug=
% h
...
% > The authors use the (somewhat formal) JML technology and introduce their =
% TDF-methodology as a variant of more classic development cycles.

% why "somewhat"?

% > Content-wise it must be said that, given the amount of material in the te=
% xt, the conclusions drawn and lessons learnt are a bit 'thin'. E.g. Does TD=
% F really work? what is your experience?

% partial agree. to be expanded, in the line of the previous comments

% > It seems that the format of the printed area (text height and width) is n=
% ot in accordance with the other conference contributions. When reformatted,=
%  the already long paper will probably get longer. The (too large) wordiness=
%  of the paper could perhaps be reduced somewhat to compensate.

% uh
% I used thir template... I'm "almost" sure
% I'll double check this
% maybe some following format options

% > page 1, abstract: 'not always see eye to eye' seems an inappropriate way =
% of stating 'do not meet face to face'.
% > page 1, abstract end: highly-spices -> highly-spiced
% > page 2, line 2: citation problem
% > page 2, line 12: 'ther'?
% > page 3, line 8 and 10: appliable in -> applicable to?
% > page 3, line 8: yeilding -> yielding
% > page 3, middle: .... the handmade test suites are automatically generated=
%  .... ?
% > page 3, the same section: the last two sentences seem crippled; split the=
% m up!
% > page 6, line -5: Identify -> Identifying
% > page 9, line 1: confidant -> confident
% > page 15, line 6: inoovative -> innovative
% > page 15, line 12: in sink -> in sync
% > page 17, last line: litt ref in disorder

% ok

% > Summing up the editorial part: Please use a spelling checker and perhaps =
% some review by a native speaker
% could help sharpening (and shortening) some sentences.

% well... I've used a spell checker!
% but we have to reread it once the modifications are in place

% ---------------------------- REVIEW 3 --------------------------
% OVERALL RATING: 2 (accept)

% > they do not mention Liu's work on the SOFL foraml engineering method for =
% software development that have been xtensively studies over the last 15 yea=
% rs with the aim to solve the similar problem. In particular, the recent pap=
% er on the application of SOFL to achieve agile process has provided a very =
% different approach from the mentioned approaches
% > Shaoying Liu, ``An Approach to Applying SOFL for Agile Process and Its Ap=
% plication in Developing a Test Support Tool'', Innovations in Systems and S=
% oftware Engineering, Springer London, 22 December, DOI 10.1007/s11334-0114-=
% 3.
...
% > I did find it disturbing that the paper never clearly distinguishes betwe=
% en structural and functional testing . This is an
% important distinction as it potentially evidences different types of proble=
% ms.

% I'll rewrite some parts to make the distinction clear

% > Moreover, there is a distinct difference between automatically generated =
% tests and manually produced tests as to how well they apply to one or the o=
% ther.

% the distinction is clear in the paper... I don't understand this

% > The overall description of how AM and FM are merged is not that persuasiv=
% e, as a result. In particular, Figure 2 does not
% convey much nor profound value in its current incarnation and description.

% mmhh
% not much that can be done here... I think
% how can we be more "persuasive"?

% > It would help if the authors would more specifically address what type of=
%  tests the JML specification helps generate. In the
% case study, it is a structural coverage type test.

% mmhh
% I've explained this
% it would take me pages to go into specific details... and I've cited
% works where this is explained

% > All that said, it is a bit unclear as to where the presented work is actu=
% ally pushing the boundaries of the current state of
% the field, other than in actually presenting the approach as an FM+AM hybri=
% d.

% we are actually talking about FM+AM hybrids... that IS the filed,
% so... what's this question about?

% > As a suggestion, then, it could be good if the verbosity and obtusity of =
% the article is reduced

% ok...

% > and a more formal and incisive treatise is presented.

% no idea how to do this
% nor I'm sure I really want to do this
