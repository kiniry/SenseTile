...
the specification of the communication protocol with the /SB, the development of 
the controlling code in the /SB, the development of the driver to communicate 
with the /SB, and the development of the simulators needed for future tests 
...
was used as a focus point that lead all the other tasks. 
...
and protocol is presented, we will present both a high level overview of the 
...
Finally in section \ref{sec:conclusions} conclusions are drawed and 
...
The subsequence accommodate data from the fast and medium data rate streams 
...
\todo describe JML specification of the high level representation of the 
package
