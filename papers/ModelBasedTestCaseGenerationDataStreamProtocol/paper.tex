...
%  A punchy abstract that makes the reader want to know more.

  Agile people hate formal people.  Formal people think agile people
  are flakes.  These two worlds do not talk to or learn from each
  other.  This is bullshit.  This paper summarizes a complex case
  study which shows that it is not only possible, but tasty, to
  combine the garlic of formal methods and the chocolate of agile
  programming.
