...
For example, in typed $\lambda$ calculi, the subtype \lstinlinenc|bit| of 
positive integer may be defined as \texttt{bit:=$\lambda$ n:nat.n < 2}. 
The corresponding informal and formal BON transformation looks like:
\input{bitbon}
