...
\subsection{Key Qualities of VHDL-AMS}
...
A simple example will highlight some of the key aspects of VHDL-AMS
language and will be used to motivate and explain our refinement.
...
\autoref{fig:transfun}), we can produce VHDL-AMS \emph{simultaneous
  statement} using \texttt{$s = d/dt = 'dot$} relation\notej{I don't
  know what this means}.

The transformation looks like the following:
\begin{equation}
  v_{in} = v_{out} + \tau_psv_{out} 
  \begin{array}[b]{c}                                                                                                                {\scriptscriptstyle s = d/dt}  \\=                                                                                 \end{array} 
...
\paragraph{Seamlessness} \emph{Seamlessness} is the use of a
continuous process throughout the software life-cycle.
